...
const YES_COMMENTS = {
  ...
  "4.04":["Provided by Mace and inspected / managed by Wilson James. Ongoing.","Firefighting equipment in date and inspected.","Fire extinguishers checked and in date."],
  "4.04b":["Good access and egress with clear routes available.","Escape routes clear and unobstructed.","All routes checked and clear."],
...
const defaultSignoff={issuedByName:"",issuedByDate:"",acceptedByName:"",acceptedByDate:"",additionalNotes:""};
...
function PrintDocument({header,items,actions,signoff,distributions,images}){
  ...
  return (
      <div style={{fontFamily:"'Segoe UI',Arial,sans-serif",color:"#1a1a1a",backgroundColor:"#fff",maxWidth:"210mm",margin:"0 auto",padding:"10mm",fontSize:"9px",lineHeight:1.4}}>
        <div style={{borderBottom:"3px solid #1a3a5c",paddingBottom:8,marginBottom:12}}>
        ...
        <table style={{width:"60%",borderCollapse:"collapse",marginBottom:12}}><tbody>
      ...
      <div style={{minHeight:"100vh",backgroundColor:t.bg,fontFamily:"'Inter','Segoe UI',-apple-system,sans-serif",color:t.text}}>
        ...
        <div style={{maxWidth:860,margin:"0 auto",padding:"20px 16px"}}>
          ...
          <div style={{backgroundColor:t.bgCard,borderRadius:12,padding:20,marginBottom:14,border:`1px solid ${t.border}`,overflow:"hidden"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:mobile?"1fr":"minmax(0,1fr) minmax(0,1fr)",gap:12}}>
              <div style={{minWidth:0,overflow:"hidden"}}><label style={{fontSize:11,fontWeight:600,color:t.textMuted,marginBottom:4,display:"block",textTransform:"uppercase",letterSpacing:"0.5px"}}>Report Issued By</label><HeaderSelect value={signoff.issuedByName} onChange={v=>updateSignoff("issuedByName",v)} options={HEADER_OPTIONS.inspectionBy} placeholder="Name" t={t} /></div>
              <div><label style={{fontSize:11,fontWeight:600,color:t.textMuted,marginBottom:4,display:"block",textTransform:"uppercase",letterSpacing:"0.5px"}}>Issue Date</label><input type="date" value={signoff.issuedByDate} onChange={e=>updateSignoff("issuedByDate",e.target.value)} style={inp} /></div>
              <div style={{minWidth:0,overflow:"hidden"}}><label style={{fontSize:11,fontWeight:600,color:t.textMuted,marginBottom:4,display:"block",textTransform:"uppercase",letterSpacing:"0.5px"}}>Report Accepted By</label><HeaderSelect value={signoff.acceptedByName} onChange={v=>updateSignoff("acceptedByName",v)} options={HEADER_OPTIONS.representative} placeholder="Name" t={t} /></div>
              <div><label style={{fontSize:11,fontWeight:600,color:t.textMuted,marginBottom:4,display:"block",textTransform:"uppercase",letterSpacing:"0.5px"}}>Acceptance Date</label><input type="date" value={signoff.acceptedByDate} onChange={e=>updateSignoff("acceptedByDate",e.target.value)} style={inp} /></div>
            </div>
