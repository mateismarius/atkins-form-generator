...
const NA_COMMENTS = {
    ...
    "1.01":["Not applicable.","No operatives on site at time of inspection."],
    "1.02":["Not applicable.","Method statement not required for current activities."],
    "1.03":["Not applicable.","No active works at time of inspection."],
    "1.04":["Not applicable.","No briefing required for current activities."],
    "1.05":["No permits required for current works.","Works do not require hot work, confined space or HV permits."],
    ...
    "2.04":["No live services in the work area.","No services affected by current works."],
    ...
    "2.09":["Not applicable.","No small tools in use at time of inspection."],
    "2.10":["Not applicable to these works.","No vibration-generating equipment in use.","No tools generating HAV in use."],
    "2.11":["Not applicable.","Works not near site boundary or access gates."],
    ...
    "4.03":["Not applicable.","Fire points not in immediate vicinity but accessible within terminal."],
    ...
    "6.01":["Not applicable - no installation works during this shift.","Inspection/survey only - no equipment being installed."],
    "6.02":["Not applicable - no checklists required for current activities.","Survey/inspection only."],
    ...
    return (
        <div style={{fontFamily:"'Segoe UI',Arial,sans-serif",color:"#1a1a1a",backgroundColor:"#fff",maxWidth:"210mm",margin:"0 auto",padding:"10mm",fontSize:"9px",lineHeight:1.4}}>
            <div style={{borderBottom:"3px solid #1a3a5c",paddingBottom:8,marginBottom:12,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                ...
                <img src={logoSrc} alt="Logo" style={{height:36,objectFit:"contain"}} />
            </div>
...
// ─── Main App ───
export default function PGIForm({ onBack, logoSrc }) {
    const t=useTheme();
